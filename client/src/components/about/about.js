...
const About = () => {
  return (
    <Box>
      <Banner />
      <Wrapper>
        <Typography variant="h3">Kalyani Bajirao</Typography>
        <Text variant="h5">
          ...
          <Box component="span" style={{ marginLeft: 5 }}>
            <Link
              href="https://github.com/kalyanibajirao"
              color="inherit"
              target="_blank"
            >
              <GitHub />
        ...
        <Text variant="h5">
          Need something built or simply want to have chat? Reach out to me an Email
          <Link
